...
if (ismember(13,[EEG.event.type]))

EEG = eeg_checkset( EEG );
EEG = pop_epoch( EEG, {  '13'  }, [-1  1], 'newname', 'BDF file epochs pruned with ICA epochs', 'epochinfo', 'yes');
...
FBN_Resp_Inc_SE1{c}=eegdata;

else

FBN_Resp_Inc_SE1{c}=N;
...
FBN_Resp_NonInc_SE1{c}=eegdata;

else

FBN_Resp_NonInc_SE1{c}=N;
...
FBN_Nonresp_Inc_SE1{c}=eegdata;

else

FBN_Nonresp_Inc_SE1{c}=N;
...
FBN_Nonresp_NonInc_SE1{c}=eegdata;

else
FBN_Nonresp_NonInc_SE1{c}=N;
...
FBN_Resp_Inc_SE2{c}=eegdata;

else

FBN_Resp_Inc_SE2{c}=N;
end
...
FBN_Resp_NonInc_SE2{c}=eegdata;

else
FBN_Resp_NonInc_SE2{c}=N;
...
FBN_Nonresp_Inc_SE2{c}=eegdata

else
FBN_Nonresp_Inc_SE2{c}=N;
...
FBN_Nonresp_NonInc_SE2{c}=eegdata;

else
FBN_Nonresp_NonInc_SE2{c}=N;

end

end

save Anhedonia_ERP_FBN FBN_Resp_Inc_SE1 FBN_Resp_NonInc_SE1 FBN_Nonresp_Inc_SE1 FBN_Nonresp_NonInc_SE1 FBN_Resp_Inc_SE2 FBN_Resp_NonInc_SE2 FBN_Nonresp_Inc_SE2 FBN_Nonresp_NonInc_SE2
