...
power_values = [id2,id3,id4,delta,theta,alpha,beta,gamma,slow,gamma2,gamma3,gamma4,total_channel];
...
disp('before_dlm')
dlmwrite('EO_before_stats_relative.csv',data_for_stats,'-append')
disp('after_dlm')
disp(c)
...
%Make Sure You Are in The Path!!!
disp('before_dlm')
dlmwrite('EO_after_stats_relative.csv',data_for_stats,'-append')
disp('after_dlm')
disp(c)
...
%Make Sure You Are in The Path!!!
disp('before_dlm')
dlmwrite('EC_before_stats_relative.csv',data_for_stats,'-append')
disp('after_dlm')
disp(c)
